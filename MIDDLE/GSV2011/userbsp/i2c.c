...
#define SET_SCL0_1     GPIOB->BSRR = GPIO_PIN_6 
#define SET_SDA0_1     GPIOB->BSRR = GPIO_PIN_7 
#define SET_SCL1_1     GPIOB->BSRR = GPIO_PIN_0
#define SET_SDA1_1     GPIOB->BSRR = GPIO_PIN_1
#define SET_SCL2_1     GPIOB->BSRR = GPIO_PIN_6 
#define SET_SDA2_1     GPIOB->BSRR = GPIO_PIN_7 


#define SET_SCL0_0     GPIOB->BSRR = GPIO_PIN_6<<16U
#define SET_SDA0_0     GPIOB->BSRR = GPIO_PIN_7<<16U
#define SET_SCL1_0     GPIOB->BSRR = GPIO_PIN_0<<16U
#define SET_SDA1_0     GPIOB->BSRR = GPIO_PIN_1<<16U
#define SET_SCL2_0     GPIOB->BSRR = GPIO_PIN_6<<16U
#define SET_SDA2_0     GPIOB->BSRR = GPIO_PIN_7<<16U



#define GET_SDA0       ((GPIOB->IDR & GPIO_PIN_7) != 0)
#define GET_SDA1       ((GPIOB->IDR & GPIO_PIN_1) != 0)
#define GET_SDA2       ((GPIOB->IDR & GPIO_PIN_7) != 0)


#define SCL0_IN        (GPIOB->CRL &= (~GPIO_CRL_MODE6_Msk))
#define SCL0_OUT       (GPIOB->CRL |= (GPIO_CRL_MODE6_Msk))
#define SDA0_IN        (GPIOB->CRL &= (~GPIO_CRL_MODE7_Msk))
#define SDA0_OUT       (GPIOB->CRL |= (GPIO_CRL_MODE7_Msk))
#define SCL1_IN        (GPIOB->CRL &= (~GPIO_CRL_MODE0_Msk))
#define SCL1_OUT       (GPIOB->CRL |= (GPIO_CRL_MODE0_Msk))
#define SDA1_IN        (GPIOB->CRL &= (~GPIO_CRL_MODE1_Msk))
#define SDA1_OUT       (GPIOB->CRL |= (GPIO_CRL_MODE1_Msk))
#define SCL2_IN        (GPIOB->CRL &= (~GPIO_CRL_MODE6_Msk))
#define SCL2_OUT       (GPIOB->CRL |= (GPIO_CRL_MODE6_Msk))
#define SDA2_IN        (GPIOB->CRL &= (~GPIO_CRL_MODE7_Msk))
#define SDA2_OUT       (GPIOB->CRL |= (GPIO_CRL_MODE7_Msk))
