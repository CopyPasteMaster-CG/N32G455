...
const uint8 ParallelConfigTable[] = {
    ...
    0x01, 0x15, 0x01,    // 10: TTL BT.1120 16-bit, SDR mode, YCbCr 422, embed sync 720
	 //0x01, 0x15, 0x10,    // 10: TTL BT.1120 16-bit, SDR mode, YCbCr 422, embed sync
    //0x01, 0x15, 0x00,    // 10: TTL BT.1120 16-bit, SDR mode, YCbCr 422, separate sync
	  //0x01, 0x11, 0x00,    // 10: TTL BT.1120 24-bit, SDR mode, RGB, separate sync
	 0x11, 0x15, 0x01,    // 10: TTL  32-bit, YUV422 DDR mode, separate sync
	//  0x11, 0x15, 0x00,    // 10: TTL  32-bit, YUV422 SDR mode, separate sync
