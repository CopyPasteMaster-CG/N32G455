...
extern AvRet AvUapiHookBspFunctions(GSV_CONFIG *gsv_config,pin AvFpI2cRead i2cRd,
...
kapi AvRet AvApiConnectPort(GSV_CONFIG *gsv_config,pin AvPort *FromPort, pin AvPort *ToPort, AvConnectType type);
...
#endif
extern AvRet AvUapiOuputDbgMsg(GSV_CONFIG *gsv_config,pin schar *stringToFormat, ...);
